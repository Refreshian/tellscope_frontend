    ...
    <Layout>
      ...
      <Content>
        ...
        <p className={styles.lead}>
          Расширенный режим: агент сам выберет инструменты, соберёт цифры и примеры со ссылками и подготовит отчёт.
          Новые задачи удобнее ставить в{' '}
          <Link to='/harness' className={styles.leadLink}>
            Центре ИИ-задач
          </Link>{' '}
          — там достаточно описать задачу словами. Нужен регулярный процесс — сохраните агента на странице «Мои агенты».
        </p>
