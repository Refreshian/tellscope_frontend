			...
			<Content>
				<div className={styles.hero}>
					<div className={styles.heroText}>
						<span className={styles.heroBadge}>DeepSeek Harness</span>
						<h2>Единый центр задач Tellscope</h2>
						<p>
							Опишите задачу обычными словами — ассистент объяснит план, выполнит её инструментами
							Tellscope, соберёт цепочку шагов или Dify-flow. Покрывает все разделы приложения:
							данные, аналитику, отчёты, агентов и визуальный конструктор.
						</p>
					</div>
