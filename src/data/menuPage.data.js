export const menuPageData = [
	{
		...
		title: 'Центр задач',
		text: 'Центр задач',
		desc: 'Опишите задачу словами — ассистент решит её инструментами Tellscope: план, аналитика, отчёт. Единая точка входа во все разделы',
		accent: true,
		tileBadge: 'AI',
		accentHint: 'все задачи приложения',
		badge: 'AI',
	...
	},
	{
		...
		title: 'Мои агенты',
		text: 'Мои агенты',
		desc: 'Сохранённые задачи: набор инструментов, модель, расписание. Отчёты складываются в папку агента',
		accent: true,
		badge: 'AI',
	...
	},
	{
		...
		text: 'Агентный режим',
		desc: 'Свободный ИИ-аналитик: сам подбирает инструменты под вопрос, показывает шаги и собирает отчёт',
		accent: true,
		badge: 'AI',
	...
	},
	{
		...
		desc: 'Визуальные цепочки из блоков: инструменты Tellscope уже подключены, схемы собираются мышкой',
		accent: true,
		sidebarOnly: true,
		badge: 'DIFY',
